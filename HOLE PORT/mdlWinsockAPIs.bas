Attribute VB_Name = "mdlWinsockAPIs"
...
'===========================
Public Const REQUEST_INFORMATION = 1
Public Const CANCEL_REQUEST = 2
Public Const OPEN_SOCKET = 3
Public Const CLOSE_SOCKET = 4
Public Const WAIT_FOR_CONNECT = 5
Public Const SEND_DATA = 6
Public Const RECEIVE_DATA = 7

Public Const STREAM = 1
Public Const DGRAM = 2
Public Const RAW = 3
Public Const RDM = 4
Public Const SEQPACKET = 5
...
Sub Center(M As Form)
M.Left = (Screen.Width - M.Width) / 2
M.Top = (Screen.Height - M.Height) / 2
End Sub


Sub StayOnTop(M As Form, S As Integer)
Dim X%
Select Case S
Case 0
X% = SetWindowPos(M.hWnd, HWND_NOTOPMOST, 0, 0, 0, 0, FLAGS)
Case 1
X% = SetWindowPos(M.hWnd, HWND_TOPMOST, 0, 0, 0, 0, FLAGS)
End Select
End Sub
